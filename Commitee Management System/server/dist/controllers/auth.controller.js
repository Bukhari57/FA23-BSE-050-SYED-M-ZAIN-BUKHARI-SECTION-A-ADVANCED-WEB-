...
export const register = asyncHandler(async (req, res) => {
    ...
    await sendEmail(user.email, 'Verify your email', `<p>Hello ${user.fullName}, verify your account token: <strong>${verifyToken}</strong></p>`);
...
export const forgotPassword = asyncHandler(async (req, res) => {
    ...
    await sendEmail(user.email, 'Reset your password', `<p>Hello ${user.fullName}, use this password reset token: <strong>${resetToken}</strong></p>`);
    res.json({ success: true, message: 'If this email exists, a reset link has been sent.' });
});
