...
export const listCommittees = asyncHandler(async (req: Request, res: Response) => {
...
export const getCommitteeById = asyncHandler(async (req: Request, res: Response) => {
...
export const rotatePayout = asyncHandler(async (req: Request, res: Response) => {
  const committee = await Committee.findById(req.params.id);
  if (!committee) {
    throw new ApiError(StatusCodes.NOT_FOUND, 'Committee not found');
  }
